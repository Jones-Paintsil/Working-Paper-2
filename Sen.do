...
set more off
capture log close
cd "J:\Data\DHS\Senegal\Senegal"


*Household Population
use "SNPR61FL.DTA",clear
...
merge m:1 hhid using  SNHR61FL.DTA  
save  pr_temp, replace

*Working the Child file
use "SNKR61FL.DTA", clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Senegal",replace