clear all
set more off
cd "J:\Data\DHS\Benin\Benin"

*Household Population
use BJPR71FL.DTA,clear
...
merge m:1 hhid using BJHR71FL.DTA 
save  pr_temp, replace

*Working the Child file
use  BJKR71FL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Benin",replace