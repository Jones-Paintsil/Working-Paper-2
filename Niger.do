...
set more off
capture log close
cd "J:\Data\DHS\Niger\Niger"
 

*Household Population
use "NIPR61FL.DTA",clear
...
merge m:1 hhid using  NIHR61FL.DTA  
save  pr_temp, replace

*Working the Child file
use "NIKR61FL.DTA", clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Niger",replace
