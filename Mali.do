...
set more off
capture log close
cd "J:\Data\DHS\Mali\Mali"
set maxvar 32000
log using childoutcomes_20141.log, replace
dir 

*Household Population
use   MLPR7AFL.DTA,clear
...
merge m:1 hhid using  MLHR7AFL.DTA  
save  pr_temp, replace

*Working the Child file
use MLKR7AFL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Mali",replace
