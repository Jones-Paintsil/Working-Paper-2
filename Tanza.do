...
set more off
capture log close
cd "J:\Data\DHS\Tanzania\Tanzania"
 

*Household Population
use "TZPR7BFL.DTA",clear
...
merge m:1 hhid using  TZHR7BFL.DTA 
save  pr_temp, replace

*Working the Child file
use "TZKR7BFL.DTA", clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Tanzania",replace