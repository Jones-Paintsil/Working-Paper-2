...
set more off
capture log close
cd "J:\Data\DHS\Lesotho\Leshotho"
dir 
set maxvar 32000
...
merge m:1 hhid using  LSHR71FL.DTA  
save  pr_temp, replace

*Working the Child file
use LSKR71FL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Lesotho",replace
