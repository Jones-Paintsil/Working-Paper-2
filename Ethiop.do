...
set more off
capture log close
cd "J:\Data\DHS\Ethiopia\Ethiopia"


*Household Population
use  ETPR71FL.DTA,clear
...
merge m:1 hhid using  ETHR71FL.DTA  
save  pr_temp, replace

*Working the Child file
use    ETKR71FL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Ethiopia",replace
