...
set more off
capture log close
cd "J:\Data\DHS\Mauritania\Mauritania"
dir

*Household Population
use MRPR71FL.DTA,clear
...
merge m:1 hhid using  MRHR71FL.DTA
drop _m
save  pr_temp, replace

*Working the Child file
use MRKR71FL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Mauritania",replace