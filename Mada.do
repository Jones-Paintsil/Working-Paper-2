...
set more off
capture log close
cd "J:\Data\DHS\Madagascar\Madagar"
dir

*Household Population
use MDPR81FL.DTA,clear
...
merge m:1 hhid using  MDHR81FL.DTA
drop _m
save  pr_temp, replace

*Working the Child file
use MDKR81FL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Madagascar",replace
