...
set more off
capture log close
cd "J:\Data\DHS\Malawi\Malawi"
 

*Household Population
use   MWPR7AFL.DTA ,clear
...
merge m:1 hhid using  MWHR7AFL.DTA 
save  pr_temp, replace

*Working the Child file
use MWKR7AFL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Malawi",replace
