...
set more off
capture log close
cd "J:\Data\DHS\Liberia\Liberia"
 

*Household Population
use   LBPR7AFL.DTA,clear
...
merge m:1 hhid using  LBHR7AFL.DTA 
save  pr_temp, replace

*Working the Child file
use LBKR7AFL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Liberia",replace
