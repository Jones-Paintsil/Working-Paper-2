...
set more off
capture log close
cd "J:\Data\DHS\Togo\Togo"
 

*Household Population
use "TGPR61FL.DTA",clear
...
merge m:1 hhid using  TGHR61FL.DTA  
save  pr_temp, replace

*Working the Child file
use "TGKR61FL.DTA", clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Togo",replace