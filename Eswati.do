...
set more off
capture log close
cd "J:\Data\DHS\Swaziland\Eswantini"


*Household Population
use "SZPR52FL.DTA",clear
...
merge m:1 hhid using  szhr51fl.dta 
save  pr_temp, replace

*Working the Child file
use "SZKR51FL.DTA", clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Eswatini",replace