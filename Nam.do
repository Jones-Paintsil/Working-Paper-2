...
merge m:1 hhid using  NMHR61FL.DTA  
save  pr_temp, replace

*Working the Child file
use "NMKR61FL.DTA", clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Namibia",replace
