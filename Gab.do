...
set more off
capture log close
cd "J:\Data\DHS\Gabon\Gabon"
 

*Household Population
use   GAPR61FL.DTA,clear
...
merge m:1 hhid using  GAHR61FL.DTA
save  pr_temp, replace

*Working the Child file
use    GAKR61FL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Gabon",replace