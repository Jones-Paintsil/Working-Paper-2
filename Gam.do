...
set more off
capture log close
cd "J:\Data\DHS\Gambia\Gambia"


*Household Population
use   GMPR81FL.DTA,clear
...
merge m:1 hhid using  GMHR81FL.DTA
save  pr_temp, replace

*Working the Child file
use    GMKR81FL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Gambia",replace