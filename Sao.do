...
set more off
capture log close
cd "J:\Data\DHS\Sao Tome\Sao_Tome"

*Household Population
use "STPR51FL.DTA",clear
...
merge m:1 hhid using STHR51FL.DTA
save  pr_temp, replace

*Working the Child file
use "STKR51FL.DTA", clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Sao_Tome",replace