...
set more off
capture log close
cd "J:\Data\DHS\Congo Democratic Republic\Congo_DR"


*Household Population
use  CDPR61FL.DTA ,clear
...
merge m:1 hhid using  CDHR61FL.DTA 
save  pr_temp, replace

*Working the Child file
use   CDKR61FL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Congo_DR",replace