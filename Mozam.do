...
set more off
capture log close
cd "J:\Data\DHS\Mozambique\Mozam"


*Household Population
use   MZPR62FL.DTA,clear
...
merge m:1 hhid using  MZHR62FL.DTA  
save  pr_temp, replace

*Working the Child file
use MZKR62FL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Mozambique",replace
