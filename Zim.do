...
set more off
capture log close
cd "J:\Data\DHS\Zimbabwe\Zimbabwe"
 

*Household Population
use "ZWPR72FL.DTA ",clear
...
merge m:1 hhid using  ZWHR72FL.DTA 
save  pr_temp, replace

*Working the Child file
use "ZWKR72FL.DTA", clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Zimbabwe",replace
