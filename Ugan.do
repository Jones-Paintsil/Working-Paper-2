...
set more off
capture log close
cd "J:\Data\DHS\Uganda\Uganda"


*Household Population
use "UGPR7BFL.DTA",clear
...
merge m:1 hhid using  UGHR7BFL.DTA 
save  pr_temp, replace

*Working the Child file
use "UGKR7BFL.DTA", clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Uganda",replace