...
set more off
capture log close
cd "J:\Data\DHS\Sierra Leone\Sierra"

*Household Population
use "SLPR7AFL.DTA",clear
...
merge m:1 hhid using  SLHR7AFL.DTA
save  pr_temp, replace

*Working the Child file
use "SLKR7AFL.DTA", clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Sierra_Leone",replace