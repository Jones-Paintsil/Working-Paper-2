...
set more off
capture log close
cd "J:\Data\DHS\Comoros\Comoros"

*Household Population
use KMPR61FL.DTA,clear
...
merge m:1 hhid using KMHR61FL.DTA  
save  pr_temp, replace

*Working the Child file
use  KMKR61FL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Comoros",replace