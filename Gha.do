...
set more off
capture log close
cd "J:\Data\DHS\Ghana\Ghana"
dir

*Household Population
use GHPR5AFL.DTA,clear
des hv103 hc1 hc27
...
merge m:1 hhid using  GHHR5AFL.DTA
save  pr_temp, replace

*Working the Child file
use GHKR5AFL.DTA, clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Ghana",replace