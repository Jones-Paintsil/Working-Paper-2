...
set more off
capture log close
cd "J:\Data\DHS\Cote D'Ivorie\Cote"

*Household Population
use  CIPR62FL.DTA ,clear
...
merge m:1 hhid using  CIHR62FL.DTA 
save  pr_temp, replace

*Working the Child file
use   CIKR62FL.DTA , clear
*size at birth
...
save "J:\Data\DHS_MSG\Merge_countries\Cote_dIviore",replace